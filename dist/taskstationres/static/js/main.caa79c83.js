...
!function (e) {
  ...
  function r(e) {
    ...
    "value" === e.propertyName && xe(Sr) && (e = be(Sr, e, Y(e)), G(we, e));
  }function Te(e, t, n) {
    ...
    if (Gr) {
      var n = Y(t);if (n = b(n), null !== n && "number" === typeof n.tag && 2 !== je(n) && (n = null), Qr.length) {
    ...
    }, f);var A = T.commitBeforeMutationLifeCycles,
    ...
    rn(n) || r("200");var i = n._reactRootContainer;if (i) {
      if ("function" === typeof a) {
        var u = a;a = function a() {
          var e = Qo.getPublicRootInstance(i._internalRoot);u.call(e);
        };
      ...
      if (i = n._reactRootContainer = an(n, o), "function" === typeof a) {
        var s = a;a = function a() {
          var e = Qo.getPublicRootInstance(i._internalRoot);s.call(e);
        };
    ...
    function t() {}function n() {
      ...
      } else Yn ? L(e, n) && (o = Gn.compositionEnd) : "topKeyDown" === e && 229 === n.keyCode && (o = Gn.compositionStart);return o ? (Kn && (Yn || o !== Gn.compositionStart ? o === Gn.compositionEnd && Yn && (a = N()) : (Ln._root = r, Ln._startText = A(), Yn = !0)), o = Bn.getPooled(o, t, n, r), a ? o.data = a : null !== (a = U(n)) && (o.data = a), O(o), a = o) : a = null, (e = qn ? z(e, n) : B(e, n)) ? (t = Hn.getPooled(Gn.beforeInput, t, n, r), t.data = e, O(t)) : t = null, null === a ? t : null === t ? a : [a, t];
    } },
      Zn = null,
    ...
    var e = new en(this),
  ...
  };var Qo = Co({ getRootHostContext: function getRootHostContext(e) {
      ...
      var e = Ko,
        ...
        if (Xe(n)) if (t = r.start, e = r.end, void 0 === e && (e = t), "selectionStart" in n) n.selectionStart = t, n.selectionEnd = Math.min(e, n.value.length);else if (window.getSelection) {
          t = window.getSelection();var o = n[j()].length;e = Math.min(r.start, o), r = void 0 === r.end ? e : Math.min(r.end, o), !t.extend && e > r && (o = r, r = e, e = o), o = Ge(n, e);var a = Ge(n, r);if (o && a && (1 !== t.rangeCount || t.anchorNode !== o.node || t.anchorOffset !== o.offset || t.focusNode !== a.node || t.focusOffset !== a.offset)) {
      ...
      Go = Qo;q = Go.batchedUpdates, K = Go.interactiveUpdates, Q = Go.flushInteractiveUpdates;var Xo = { createPortal: sn, findDOMNode: function findDOMNode(e) {
    ...
    }, unstable_batchedUpdates: Qo.batchedUpdates, unstable_deferredUpdates: Qo.deferredUpdates, flushSync: Qo.flushSync, unstable_flushControlled: Qo.flushControlled, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: { EventPluginHub: jn, EventPluginRegistry: Tn, EventPropagators: Dn, ReactControlledComponent: rr, ReactDOMComponentTree: Fn, ReactDOMEventListener: Xr }, unstable_createRoot: function unstable_createRoot(e, t) {
  ...
  function r(e, t) {
    ...
    function e(e, t) {
      ...
      l = function (e) {
    function t(e) {
      r(this, t);var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));n.state = { mainFunctions: { getApi: n.getApi.bind(n) } };return window.open("Result.html", "null", "location=no,toolbar=no,menubar=no,scrollbars=yes,resizable=yes"), n;
  ...
  function r(e) {
      ...
      o(this, t);var n = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));return n.state = { currentStatus: "", currentSeasonProfile: {}, lastSeasonProfile: {}, loaded: !1 }, n;
    }return i(t, e), M(t, [{ key: "componentDidMount", value: function value() {
        this.initHome();
        ...
        for (var e = "", t = 0; t < 3; t++) {
          if (!this.props.assignments[t].played) {
            e = "taskToBeAccept";break;
          }if (this.props.assignments[t].played && !this.props.assignments[t].complete) {
            e = "taskOnGoing";break;
          }if (2 === t) {
            e = "stampEarned";break;
          }if (this.props.assignments[t].complete && !this.props.assignments[t + 1].played) {
        ...
        "allTasksCompleted" === this.state.currentStatus ? window.location.reload() : "lastTaskCompleted" === this.state.currentStatus ? this.setState({ currentStatus: "taskToBeAccept" }) : "taskToBeAccept" === this.state.currentStatus && this.props.contentFunctions.taskAccepted();
        ...
        var e = this;if (!this.state.loaded) return l.a.createElement("div", null);var t = { height: this.props.height, width: 1.7 * this.props.height + "px", display: "flex", flexFlow: "row nowrap" },
          ...
          } })))) : l.a.createElement("div", { style: Object.assign({}, n, { flex: 18 }) }, l.a.createElement(D.a, { currentStatus: this.state.currentStatus, assignment: this.props.currentAssignment, height: this.props.height }), l.a.createElement("div", { style: { flex: 1, display: "flex", flexFlow: "row nowrap" } }, l.a.createElement("button", { onClick: function onClick() {
  ...
  function r(e, t) {
    ...
    function t() {
      return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
        ...
        return e >= 79 ? c.a : e >= 71 ? f.a : e >= 63 ? d.a : e >= 55 ? m.a : e >= 47 ? y.a : e >= 39 ? b.a : e >= 31 ? x.a : e >= 23 ? C.a : e >= 17 ? T.a : e >= 13 ? _.a : e >= 9 ? O.a : e >= 6 ? j.a : e >= 4 ? A.a : e >= 2 ? F.a : M.a;
      } }, { key: "render", value: function value() {
  ...
  function r(e, t) {
    ...
    function t() {
      return r(this, t), o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
        ...
        return "lastTaskCompleted" === this.props.currentStatus ? de.a : 0 === e ? c.a : 1 === e ? f.a : 2 === e ? d.a : 3 === e ? m.a : 4 === e ? y.a : 5 === e ? b.a : 6 === e ? b.a : 7 === e ? x.a : 8 === e ? C.a : 9 === e ? T.a : 10 === e ? _.a : 11 === e ? O.a : 12 === e ? j.a : 13 === e ? A.a : 14 === e ? F.a : 15 === e ? M.a : 16 === e ? U.a : 17 === e ? B.a : 18 === e ? W.a : 19 === e ? $.a : 20 === e ? K.a : 21 === e ? G.a : 22 === e ? Y.a : 23 === e ? Z.a : 24 === e ? te.a : 25 === e ? re.a : 26 === e ? ae.a : 27 === e ? ue.a : 28 === e ? ce.a : 29 === e ? fe.a : ce.a;
      } }, { key: "render", value: function value() {
    ...
    function t(e) {
      r(this, t);var n = o(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));return n.state = { page: 0 }, n;
        ...
        var e = this,
            ...
            a = { height: .1 * this.props.height, width: 1.1 * this.props.height, fontFamily: "adobestdb", textAlign: "left", lineHeight: 1.25, fontSize: .04 * this.props.height, color: "white", fontWeight: "bold" },
            i = u.a.createElement("div", { style: a }, "*\u6BCF\u4E09\u500B\u6708\u91CD\u65B0\u8A08\u7B97\u4E00\u6B21"),
            ...
            e.switchPage(-1);
          }, style: Object.assign({}, r, { left: .05 * this.props.height, backgroundImage: "url(" + m.a + ")" }) }), s, 0 !== this.state.page && i, 2 !== this.state.page && u.a.createElement("button", { onClick: function onClick() {
            e.switchPage(1);
    ...
    function t(e) {
      o(this, t);var n = a(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e));return n.state = { currentSeasonProfile: {}, loaded: !1 }, n;
        ...
        function e() {
          ...
          var t, n, r, o, a, i, u, c, l;return s.a.wrap(function (e) {
            for (;;) {
              switch (e.prev = e.next) {case 0:
                  return t = this.props.profile.MemID, n = this.props.mainFunctions.getApi() + "resident/all/quarter/performance/" + t, e.next = 4, p.a.get(n);case 4:
                  for (r = e.sent, o = r.data, a = new Date(), i = {}, u = 0; u < o.length; u++) {
                    c = new Date(o[u].quarterFrom), l = new Date(o[u].quarterTo), a > c && a < l && (i = o[u]);
                  }this.setState({ currentSeasonProfile: i, loaded: !0 }), console.log(this.state);case 11:case "end":
                  return e.stop();}
            }
          }, e, this);
        }));return e;
        ...
        var e = this,
            t = [v.a, w.a, k.a, E.a, S.a, P.a];return Array.from("23165432135316513124153612313542313653241561453216541312315645133215231354652313542653435516").map(function (n, r) {
  ...
  (function (e, r) {
    function o(e) {
      ...
      var r = function r(t) {
        ...
        function e(t, n, r) {
          if (Q(this, e), this.rules = t, this.isStatic = !Ve && We(t, n), this.componentId = r, !Ee.master.hasId(r)) {
  ...
  }var o = n(141);e.exports = function (e) {
  ...
  !function (t) {
    ...
    function n(e, t, o, s, f) {
      for (var p, d, h = 0, y = 0, v = 0, b = 0, w = 0, x = 0, k = 0, C = 0, E = 0, T = 0, S = 0, I = 0, j = 0, N = 0, A = 0, R = 0, F = 0, M = 0, L = 0, U = o.length, z = U - 1, oe = "", je = "", Ne = "", De = "", Le = "", Ue = ""; A < U;) {
        if (k = o.charCodeAt(A), A === z && y + b + v + h !== 0 && (0 !== y && (k = y === le ? Y : le), b = v = h = 0, U++, z++), y + b + v + h === 0) {
          if (A === z && (R > 0 && (je = je.replace(g, "")), je.trim().length > 0)) {
            switch (k) {case te:case Z:case V:case J:case Y:
                break;default:
                je += o.charAt(A);}k = V;
          }if (1 === F) switch (k) {case q:case $:case V:case ce:case se:case K:case Q:case ie:
              ...
              for (je = je.trim(), w = je.charCodeAt(0), S = 1, L = ++A; A < U;) {
                switch (k = o.charCodeAt(A)) {case q:
                  ...
                  switch (R > 0 && (je = je.replace(g, "")), x = je.charCodeAt(1)) {case Ee:case ve:case be:case re:
                      p = t;break;default:
                      p = Fe;}if (Ne = n(t, p, Ne, x, f + 1), L = Ne.length, Re > 0 && 0 === L && (L = je.length), Me > 0 && (p = r(Fe, je, M), d = l(Ve, Ne, p, t, _e, Se, L, x, f, s), je = p.join(""), void 0 !== d && 0 === (L = (Ne = d.trim()).length) && (x = 0, Ne = "")), L > 0) switch (x) {case be:
              ...
              if (je = (R > 0 ? je.replace(g, "") : je).trim(), (L = je.length) > 1) switch (0 === N && ((w = je.charCodeAt(0)) === re || w > 96 && w < 123) && (L = (je = je.replace(" ", ":")).length), Me > 0 && void 0 !== (d = l(He, je, t, e, _e, Se, De.length, s, f, s)) && 0 === (L = (je = d.trim()).length) && (je = "\0\0"), w = je.charCodeAt(0), x = je.charCodeAt(1), w + x) {case he:
            ...
            if (y + b + v + h + Ae === 0) switch (T) {case Q:case se:case ce:case ee:case de:case fe:case ae:case pe:case le:case re:case ue:case ie:case V:case q:case $:
                break;default:
                N > 0 && (F = 1);}y === le ? y = 0 : Oe + I === 0 && (R = 1, je += "\0"), Me * $e > 0 && l(Be, je, t, e, _e, Se, De.length, s, f, s), Se = 1, _e++;break;case V:case $:
            if (y + b + v + h === 0) {
              Se++;break;
            }default:
            switch (Se++, oe = o.charAt(A), k) {case Z:case te:
                ...
                0 === y && (b = b === k ? 0 : 0 === b ? k : b);break;case G:
                b + y + v === 0 && h++;break;case X:
                b + y + v === 0 && h--;break;case Q:
              ...
              if (Oe + b + h + j === 0 && s !== ye && k !== V) switch (k) {case ie:case de:case fe:case pe:case Q:case K:
                  if (0 === I) {
                  ...
                  switch (C) {case he:case q:case $:case V:case ie:case me:case Z:case te:case Y:case J:
                      break;default:
                      0 === I && (R = 1, oe += "\0");}}je += oe, k !== te && k !== Z && (T = k);
            }}E = C, C = k, A++;
      }if (L = De.length, Re > 0 && 0 === L && 0 === Le.length && 0 === t[0].length === !1 && (s !== ve || 1 === t.length && (Oe > 0 ? Qe : Ge) === t[0]) && (L = t.join(",").length + 2), L > 0) {
      ...
      var o = t,
          ...
          switch (o.charCodeAt(1)) {case 103:
              if (je > 0 && Oe > 0) return o.replace(T, "$1").replace(E, "$1" + Ge);break;default:
          ...
          if (!(0 === (c = (n = i[s]).length) && p > 1)) {
            if (l = u.charCodeAt(u.length - 1), f = n.charCodeAt(0), t = "", 0 !== s) switch (l) {case ae:case de:case fe:case pe:case te:case K:
                ...
                switch (2 * n.charCodeAt(1) + 3 * n.charCodeAt(2)) {case 530:
                    ...
                    (s < 1 || i[s - 1].length < 1) && (n = t + Qe + n);}break;case ie:
                t = "";default:
                n = c > 1 && n.indexOf(":") > 0 ? t + n.replace(R, "$1" + Qe + "$2") : t + n + Qe;}u += n;
          }
      ...
      if (void 0 !== this && this.constructor === h) return e(t);var o = t,
          a = o.charCodeAt(0);a < 33 && (a = (o = o.trim()).charCodeAt(0)), qe > 0 && (Ke = o.replace(S, a === G ? "" : "-")), a = 1, 1 === Oe ? Ge = o : Qe = o;var i,
          u = [Ge];Me > 0 && void 0 !== (i = l(ze, r, u, u, _e, Se, 0, 0, 0, 0)) && "string" === typeof i && (r = i);var s = n(Fe, u, r, 0, 0);return Me > 0 && void 0 !== (i = l(Ue, s, u, u, _e, Se, s.length, 0, 0, 0)) && "string" !== typeof (s = i) && (a = 0), Ke = "", Ge = "", Qe = "", Pe = 0, _e = 1, Se = 1, Ne * a === 0 ? s : f(s);
    }var m = /^\0+/g,
        g = /[\0\r\f]/g,
        y = /: */g,
        v = /zoo|gra/,
...
//# sourceMappingURL=main.caa79c83.js.map
//# sourceMappingURL=main.caa79c83.js.map